        ...
        <div className="row">
          {
            FeatureData.map((v,i) => {
              return (
                <div key={i} className={`col-md-4 mb-4 ${styles.features}`} data-aos="fade-in">
            <Image src={v.img} width={70} height={70} />
            <h5 style={{fontFamily:'sans-serif'}} className="font-weight-bold my-4">{v.heading}</h5>
