...
function ServicesCommon(props) {
  return (
    <div className="container mt-5">
      <section className="dark-grey-text" data-aos="fade-in" data-aos-delay="300">
        <div
        ...
        >
          ...
          <div className="col-lg-7 col-xl-8">
            ...
            <a href="/contact" target="_blank" className={`btn btn-md mx-0 btn-rounded ${styles.btn_about}`}>
              {props.btnTxt}
            </a>
          </div>
        </div>
